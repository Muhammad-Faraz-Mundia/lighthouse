    ...
    <main>
          ...
          <div class="w-full max-w-[850px]">
            ...
            <div class="flex flex-col items-center gap-4 sm:flex-row fade-in-animation">
              ...
              <a class="flex w-full items-center justify-center gap-2.5 rounded border border-white px-9 py-3.5 text-center text-xl font-bold text-white transition-all hover:border-primary-700 hover:bg-white hover:text-primary-700 sm:w-fit sm:py-5 sm:text-2xl" href="tel:18002788107"
                ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="h-5 w-5 text-current">
        ...
        <div class="swiper hero-background-slides absolute inset-0 -z-20 pointer-events-none size-full">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img alt="background" class="pointer-events-none h-full w-full object-cover" src="assets/images/hero.jpg" />
            </div>
            <div class="swiper-slide">
              <img alt="background" class="pointer-events-none h-full w-full object-cover" src="https://images.pexels.com/photos/936722/pexels-photo-936722.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" />
            </div>
            <div class="swiper-slide">
              <img alt="background" class="pointer-events-none h-full w-full object-cover" src="https://images.pexels.com/photos/373965/pexels-photo-373965.jpeg?auto=compress&cs=tinysrgb&w=800&lazy=load" />
            </div>
            <div class="swiper-slide">
              <img alt="background" class="pointer-events-none h-full w-full object-cover" src="https://images.pexels.com/photos/332966/pexels-photo-332966.jpeg?auto=compress&cs=tinysrgb&w=800&lazy=load" />
            </div>
            <div class="swiper-slide">
              <img alt="background" class="pointer-events-none h-full w-full object-cover" src="https://images.pexels.com/photos/11350133/pexels-photo-11350133.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" />
            </div>
          </div>
        </div>
        <div class="pointer-events-none absolute inset-0 -z-10 hidden h-full w-full lg:block" style="background: linear-gradient(90deg, rgba(0, 21, 36, 0.92) 0%, rgba(0, 21, 36, 0.7268) 60.88%, rgba(0, 21, 36, 0) 93.05%)"></div>
        ...
        <div class="mx-auto w-full max-w-[1200px]">
          <div class="mx-auto grid w-full grid-cols-2 gap-14 px-6 sm:mx-0 sm:w-auto sm:max-w-none sm:grid-cols-2 sm:gap-8 lg:grid-cols-4">
            <div class="text-center">
              <img alt="Medical Industry" width="126" height="126" class="mx-auto mb-9 block h-16 w-16 object-contain" src="assets/images/medical-industry.webp" />
              <p class="mb-3 text-xl font-bold text-dark">Medical Industry</p>
              <p class="hidden text-lg leading-normal text-dark md:block">When it comes to medical PCBs, trust the experts. Our PCBs are designed to meet the highest standards of quality.</p>
            </div>
            <div class="text-center">
              <img alt="Medical Industry" width="126" height="126" class="mx-auto mb-9 block h-16 w-16 object-contain" src="assets/images/medical-industry.webp" />
              <p class="mb-3 text-xl font-bold text-dark">Aerospace Industry</p>
              <p class="hidden text-lg leading-normal text-dark md:block">Our PCBs are trusted by the aerospace industry for their high reliability and quality. Discover why our PCBs are the right choice.</p>
            </div>
            <div class="text-center">
              <img alt="Medical Industry" width="126" height="126" class="mx-auto mb-9 block h-16 w-16 object-contain" src="assets/images/medical-industry.webp" />
              <p class="mb-3 text-xl font-bold text-dark">Automotive Industry</p>
              <p class="hidden text-lg leading-normal text-dark md:block">Our PCBs are the perfect fit for the automotive industry. With high durability and reliability, our printed circuit boards.</p>
            </div>
            <div class="text-center">
              <img alt="Medical Industry" width="126" height="126" class="mx-auto mb-9 block h-16 w-16 object-contain" src="assets/images/medical-industry.webp" />
              <p class="mb-3 text-xl font-bold text-dark">Military Applications</p>
              <p class="hidden text-lg leading-normal text-dark md:block">Our PCBs are designed to meet the rigorous demands of military operations. Count on us for superior quality.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="w-full max-w-7xl px-5 lg:px-10 mx-auto">
          <div class="w-full justify-start items-center xl:gap-12 gap-10 grid lg:grid-cols-2 grid-cols-1">
            <div class="w-full flex-col justify-center lg:items-start items-center gap-10 inline-flex">
              ...
              <a class="btn-secondary w-full border border-secondary-500 px-12 py-3.5 text-2xl leading-normal hover:border-yellow-500 sm:w-fit sm:py-5" href="https://mundiatech.xyz/lighthouse/about.php">Read More</a
              >
            </div>
            <div class="w-full lg:justify-start justify-center items-start flex">
              <div class="sm:w-[564px] w-full sm:h-[646px] h-full sm:bg-gray-100 rounded-3xl sm:border border-gray-200 relative">
                <img class="sm:mt-5 sm:ml-5 w-full h-full rounded-3xl object-cover" src="https://images.pexels.com/photos/15978382/pexels-photo-15978382/free-photo-of-oil-train-carriages-near-petrol-refinery-in-trzebinia-poland.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="about Us image" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="my-20 fade-in-animation three-boxes">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 grid-container">
          ...
          <!--  <div class="absolute flex flex-col px-[12%] bg-[rgba(40,40,40,.6)] group-hover:bg-[rgba(40,40,40,.2)] transition-all justify-center text-white inset-0 size-full z-10">-->
          <!--    <h4 class="text-[46px] font-bold mb-4 group-hover:drop-shadow-2xl">Education</h4>-->
          <!--    <p class="text-xl">Textline here</p>-->
          <!--  </div>-->
          <!--</div>-->
        </div>
      </section>
      ...
      <section class="my-10 py-10 px-6 lg:px-10 fade-in-animation">
        <div class="container max-w-7xl mx-auto">
          ...
          <p class="text-lg lg:text-2xl mb-5 leading-relaxed">Lighthouse Consulting offers the full spectrum of strategy, operations, implementation, and managed services with a change-focused, data-driven approach. Leveraging decades of client commitment and industry experience, we deliver solutions that work for your business and people to drive growth, innovation, and transformation.</p>
